        ...
        onView(withId(R.id.camera))
                ...
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        ...
                        AspectRatio viewRatio = AspectRatio.Companion.of(view.getWidth(), view.getHeight());
        ...
        onView(withId(R.id.camera))
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        ...
                        AspectRatio textureRatio = AspectRatio.Companion.of(
    ...
    public void testFacing() {
        onView(withId(R.id.camera))
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        CameraView cameraView = (CameraView) view;
                        assertThat(cameraView.getFacing(), is(CameraView.Companion.getFACING_BACK()));
                        cameraView.setFacing(CameraView.Companion.getFACING_FRONT());
                        assertThat(cameraView.getFacing(), is(CameraView.Companion.getFACING_FRONT()));
                    }
                })
                .perform(waitFor(1000))
                .check(showingPreview());
    ...
    public void testFlash() {
        onView(withId(R.id.camera))
                .check(new ViewAssertion() {
                    ...
                    public void check(View view, NoMatchingViewException noViewFoundException) {
                        CameraView cameraView = (CameraView) view;
                        assertThat(cameraView.getFlash(), is(CameraView.Companion.getFLASH_AUTO()));
                        cameraView.setFlash(CameraView.Companion.getFLASH_TORCH());
                        assertThat(cameraView.getFlash(), is(CameraView.Companion.getFLASH_TORCH()));
                    }
                });
    }
